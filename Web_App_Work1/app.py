...
def predict():
    ...
    if form.submit():
        ...
        header = {'Content-Type': 'application/json', 'Authorization': 'Bearer '
                 + "zxMxG9GkS4moZXHpqRZzjoIUWbQdJd43gL1vxmgMfP6H"}
        ...
        response_scoring = requests.post("https://us-south.ml.cloud.ibm.com/ml/v4/deployments/f80e55f2-d737-4e74-aaf5-dba413afa8f8/predictions?version=2020-09-01", json=payload_scoring, headers=header)
